    ...
    val menuItems = listOf(
        ...
        if(user.isProducer) {
            ...
            ProfileMenuItem(
                ...
                label =  stringResource(R.string.profile_go_pro_title),
                description = stringResource(R.string.profile_go_pro_desc),
                onClick = onConvertToProducer,
                badge = stringResource(R.string.profile_go_pro_badge),
            )
        } else {
            ProfileMenuItem(
                icon = Icons.Outlined.Store,
